...
const en = {
  ...
  auth: {
    ...
    login: {
      ...
      identifier_ph: 'Enter your email or username',
      password: 'Password',
    ...
    forgot: {
      ...
      email_ph: 'Enter your registered email',
...
const vi = {
  ...
  auth: {
    ...
    login: {
      ...
      identifier_ph: 'Nhập email hoặc tên đăng nhập',
      password: 'Mật khẩu',
    ...
    register: {
      ...
      email: 'Email',
      email_ph: 'Nhập địa chỉ email của bạn',
      password: 'Mật khẩu',
      password_ph: 'Tối thiểu 6 ký tự',
    ...
    forgot: {
      ...
      email_ph: 'Nhập email đã đăng ký',
